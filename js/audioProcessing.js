FourierAnalyser = function(context, freqBinNumber = Math.pow(2,15))
{
...
Note = function(frequency, name = 'NONE', history_length = 100)
{
...
ChromaticScale = function(center_frequency = 440, N = 1)
{
	...
	for (let entry of this.note_frequencys.entries())
	{
		i = entry[0]
		freq = entry[1]
		this.notes.push(new Note(freq,this.note_names[i]))
	}
